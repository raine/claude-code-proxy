...
import { mapUsageToAnthropic, reduceUpstream, UpstreamStreamError, type GeminiUsage } from "./reducer.ts"
import { makeThinkingSignature } from "../../kimi/translate/signature.ts"
...
export function translateStream(
  ...
  return new ReadableStream<Uint8Array>({
    async start(controller) {
      ...
      let contentChars = 0
      let toolCount = 0
      let finishUsage: GeminiUsage | undefined
